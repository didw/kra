...
class mean_data:
    def __init__(self):
        ...
        self.race_score = \
            {900:  [629, 641, 640, 639, 638, 640, 638, 640, 640, 639, 640, 640, 639, 635, 641, 638, 637, 635, 635, 633, 638],
             1000: [629, 641, 640, 639, 638, 640, 638, 640, 640, 639, 640, 640, 639, 635, 641, 638, 637, 635, 635, 633, 638],
             1200: [768, 771, 778, 776, 777, 775, 773, 775, 778, 778, 779, 776, 777, 774, 776, 769, 772, 771, 772, 769, 775],
             1300: [837, 836, 847, 844, 843, 843, 841, 844, 847, 848, 845, 846, 843, 840, 845, 836, 840, 841, 840, 836, 843],
             1400: [897, 899, 906, 904, 905, 904, 903, 903, 908, 910, 908, 903, 901, 904, 900, 897, 901, 897, 899, 894, 903],
             1700: [1118, 1137, 1146, 1144, 1145, 1145, 1142, 1145, 1144, 1148, 1150, 1144, 1143, 1144, 1133, 1139, 1136, 1131, 1130, 1133, 1142],
             0: [813, 821, 826, 824, 824, 825, 823, 825, 826, 827, 827, 825, 824, 822, 823, 820, 821, 818, 819, 816, 823]
             }
    ...
    def update_data(self, df):
        ...
        for i in range(21):
            self.race_score[0][i] = (self.race_score[900][i] + self.race_score[1000][i] + self.race_score[1200][i] + self.race_score[1300][i] + self.race_score[1400][i] + self.race_score[1700][i]) / 6
